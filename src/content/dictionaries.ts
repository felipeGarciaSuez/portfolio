...
const es = {
  ...
  infra: {
    ...
    lede: "No dependo de una plataforma para que mi código exista. Compré un servidor, lo aseguré, lo documenté y ahí corren mis aplicaciones.",
...
const en: Dictionary = {
  ...
  infra: {
    ...
    lede: "I don't depend on a platform for my code to exist. I bought a server, hardened it, documented it, and that's where my applications run.",
